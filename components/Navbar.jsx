...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed bottom-0 left-0 w-full z-[100] transition-all duration-300 ${
        isScrolled 
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:block mx-auto">
            <Dock 
              ...
              baseItemSize={48}
              magnification={60}
              className="bg-gray-100 dark:bg-gray-900 bg-opacity-90 backdrop-blur-md rounded-lg"
            />
          </div>
